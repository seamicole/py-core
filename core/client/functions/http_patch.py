...
def http_patch(request: HTTPRequest) -> HTTPResponse:
    """Makes an HTTP PATCH request and returns a HTTPResponse instance"""
...
async def http_patch_async(request: HTTPRequest) -> HTTPResponse:
    """Makes an HTTP PATCH request and returns a HTTPResponse instance"""
    ...
    async with httpx.AsyncClient(
        ...
        # Make the request
        response_httpx = await client.patch(
            url=request.url,
            params=request.params,
            data=request.data,
            json=request.json,
