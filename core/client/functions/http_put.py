...
def http_put(request: HTTPRequest) -> HTTPResponse:
    """Makes an HTTP PUT request and returns a HTTPResponse instance"""
...
async def http_put_async(request: HTTPRequest) -> HTTPResponse:
    """Makes an HTTP PUT request and returns a HTTPResponse instance"""
    ...
    async with httpx.AsyncClient(
        ...
        # Make the request
        response_httpx = await client.put(
            url=request.url,
            params=request.params,
            data=request.data,
            json=request.json,
